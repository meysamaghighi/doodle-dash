...
export default function SpiralDraw() {
  ...
  const startDraw = (e: React.MouseEvent | React.TouchEvent) => {
    ...
    // so a tap produces the round-cap dot a minimal drag would. Before this
    // fix, points.current still got the tap's point (feeding analyzeSpiral's
    // score) even though nothing was ever painted — silently scoring an
    // invisible mark.
    drawStroke(pos, pos);
  };
