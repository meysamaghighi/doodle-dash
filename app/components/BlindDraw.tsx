        ...
        <>
          ...
          <div className="relative">
            <canvas
              ...
              width={512}
              height={512}
              className="w-full aspect-square rounded-xl border border-line touch-none cursor-crosshair"
            ...
            />
            {phase === "drawing" && (
              <div className="absolute inset-0 bg-paper-2 rounded-xl flex items-center justify-center pointer-events-none">
                <div className="text-center">
                  <svg
                    className="w-16 h-16 text-ink-3 mx-auto mb-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-ink-3 text-lg">Drawing blind...</p>
